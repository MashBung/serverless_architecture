# Blood Cell Classification with AWS Serverless Architecture

## 프로젝트 개요

혈액세포 이미지를 업로드하면 AI가 자동으로 세포 유형을 분류해주는 서버리스 웹 애플리케이션입니다. AWS의 다양한 관리형 서비스를 활용하여 확장 가능하고 비용 효율적인 인프라를 구축했습니다.
